      ...
      <div className="container create-runner-form mt-5 p-4 shadow mb-5">
        ...
        <div className="mb-3">
          ...
          <input
            ...
            onChange={(e) =>
              setRunner({ ...runner, years_running: e.target.value })
            }
        ...
        <div className="mb-3">
          <label htmlFor="rating" className="ms-2 mb-1">
            Rating
          </label>
          <input
            id="rating"
        ...
        <div className="mb-3">
          <label htmlFor="level" className="ms-2 mb-1">
            Level
          </label>
          <input
            id="level"
        ...
        <div className="form-check">
          <input
            ...
            onChange={(e) =>
              setRunner({ ...runner, is_mentor: e.target.value === "true" })
            }
            value="true"
        ...
        <div className="d-flex justify-content-center">
          <button className="nav-btn" onClick={(e) => handleCreateRunner(e)}>
