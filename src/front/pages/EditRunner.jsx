...
export const EditRunner = () => {
  ...
  const [currentRunnerInfo, setCurrentRunnerInfo] = useState({
    name: "",
    phone: "",
    email: "",
    address: "",
  ...
  useEffect(() => {
    let currentRunner = store.runners.filter(
      ...
      <div className="container edit-runner-form mt-5 p-4 shadow mb-5">
        ...
        <div className="mb-3">
          ...
          <input
            ...
            onChange={(e) =>
              setNewRunnerInfo({ ...newRunnerInfo, name: e.target.value })
            }
          />
        </div>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            onChange={(e) =>
              setNewRunnerInfo({ ...newRunnerInfo, phone: e.target.value })
            }
          />
        </div>
